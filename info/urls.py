...
urlpatterns = [
    ...
    path('blog/post/<str:slug>/', views.BlogPostDetail.as_view(), name='blog_post_detail_url'),
    path('blog/categories/', views.BlogCategories.as_view(), name='blog_categories_url'),
    path('blog/category/<str:slug>/', views.BlogCategoryDetail.as_view(), name='blog_category_detail_url'),
